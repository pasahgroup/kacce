        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="<?php echo e(route('employee.create')); ?>" class="btn btn-primary" >
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!--    <td><?php echo e($data->main); ?></td>
                     <td><?php echo e($data->tour_code); ?></td> -->
                      <td><div class="logo mr-auto"><img src="<?php echo e(URL::asset('/storage/employees/'.$data->photo)); ?>"  style="width:100px; height:60px;"></div></td>
   
   <td><?php echo e($data->reg_date); ?></td>
...
<button type="submit" role="button" class="btnn btn-primary"><i class="fa fa-bars"></i></button>
  ...
  <?php if(Auth::user()->role =='Admin'): ?>
                      <a role="button" href="<?php echo e(route('editemployee',$data->id)); ?>" class="btnn btn-secondary"><i class="fa fa-edit"></i></a> 
                      <?php endif; ?>
                     
                      <a role="button" class="btnn btn-success" href="/destroyEmployee/<?php echo e($data->id); ?> " onclick="return confirm('Are you sure? You want to delete <?php echo e($data->tour_name); ?>','Inclusive')"><i class="fa fa-trash red"></i></i></a>
...
<?php echo $__env->make('admins.layouts.Apps.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\assetf\resources\views/admins/employee/employee.blade.php ENDPATH**/ ?>