    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-11 form-box">
                <form method="post" id="post_form" role="form" class="registration-form" action="<?php echo e(route('employee.store')); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make('admins.layouts.Apps.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\assetf\resources\views/admins/employee/add-employee.blade.php ENDPATH**/ ?>