          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              ...
              <div class="container-fluid x_content">
                <br />
              <form  method="post" id="post_form" action="<?php echo e(route('relation.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admins.layouts.Apps.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hmff\resources\views/admins/relations/addrelation.blade.php ENDPATH**/ ?>