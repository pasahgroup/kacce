            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark activex" data-toggle="tab" href="#tab-pane-1">Description  {{$detail->section}}</a>
                    </div>
                    <div class="tab-content">                        
                            <p>{{$detail->description}}</p>                                    
                      
                       <!-- <a  type="button" class="btn btn-primary px-3" href="/detail-page/{{$detail->id}}"><i class="fa fa-angle-double-left"></i> </a> -->
                        <a  type="button" class="btn btn-primary px-3" href="/dp/{{$detail->section}}"><i class="fa fa-angle-double-left"></i> </a>
